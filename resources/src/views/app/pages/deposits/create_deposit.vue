    ...
    GetElements() {
      axios
        ...
        .then(response => {
          ...
          const cashCategory = this.deposit_category.find(cat => cat.title.toUpperCase() === 'CASH');
          if (cashCategory) {
            this.deposit.category_id = cashCategory.id;
          }
