...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    updateNote: function updateNote() {
      ...
      if (warehouse) {
        var shortform = "";
        var name = warehouse.name.toUpperCase();
        if (name.includes("SHANTI")) shortform = "STM";else if (name.includes("NIMAR")) shortform = "NP";else if (name.includes("SARAL")) shortform = "SR";else if (name.includes("SARVESHWAR")) shortform = "SP";
        if (shortform) {
          note += shortform + ":";
        }
      }
    ...
    GetElements: function GetElements() {
      ...
      axios.get("sales/create").then(function (response) {
        ...
        _this15.transporters = response.data.transporters;
