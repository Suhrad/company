  ...
  methods: {
    ...
    GetElements: function GetElements() {
      ...
      axios.get("sales/".concat(id, "/edit")).then(function (response) {
        ...
        _this9.transporters = response.data.transporters;
        ...
        _this9.pointsConverted = _this9.sale.used_points > 0;
    ...
    updateNote: function updateNote() {
      ...
      var warehouse = this.warehouses.find(function (w) {
        return w.id === _this0.sale.warehouse_id;
      });
      if (warehouse) {
        var shortform = "";
