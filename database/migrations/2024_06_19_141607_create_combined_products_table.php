...
class CreateCombinedProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('combined_products', function (Blueprint $table) {
            ...
            $table->foreign('product_id', 'combined_products_product_id_idx')->references('id')->on('products')->onUpdate('RESTRICT')->onDelete('RESTRICT');
            $table->foreign('combined_product_id', 'combined_products_combined_product_id_idx')->references('id')->on('products')->onUpdate('RESTRICT')->onDelete('RESTRICT');
